						...
						<ul>
							...
							<a class="btn btn-default update" href="">Update</a><br>
							 ...
							 <?php if($customer_id != NULL){ ?>
                               ...
                               <li><a  class="btn btn-default" href="{{URL::to('/checkout')}}"><i class="fa fa-crosshairs"></i> Checkout</a></li>
                                  
                              <?php  }else{?>
                               <li><a class="btn btn-default check_out" href="{{URL::to('/login-check')}}"><i class="fa fa-crosshairs"></i> Checkout</a></li>
                              <?php } ?>
					</div>
				</div>
			</div>

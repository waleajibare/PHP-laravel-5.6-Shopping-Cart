...
@section('admin_content')
      ...
      <div class="row-fluid sortable">
      	<div class="box span6">
      		<div class="box-header">
      			<h2><i class="haflings-icon align-justify"></i><span class="break"></span>Customer Details</h2>
      		</div>
      	...
      	<div class="box span6">
      		<div class="box-header">
      			<h2><i class="haflings-icon align-justify"></i><span class="break"></span>Shipping Details</h2>
      		</div>
      ...
      <div class="row-fluid sortable">
      	<div class="box span12">
      		...
      		<h2><i class="haflings-icon align-justify"></i><span class="break"></span>Order Details</h2>
      		</div>
      		<div class="box-content">
      			<table class="table table-striped" >
      				<thead>

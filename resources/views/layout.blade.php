                            ...
                            <div class="brands-name">
                                <ul class="nav nav-pills nav-stacked">
                                    <?php
                                     ...
                                     $all_published_brands = DB::table('manufacture')
                                                          ->where('publication_status', 1)
                                                          ->get();

                                
                                    foreach ($all_published_brands as $v_brand){?>
                                    <li><a href="{{ URL::to('/product_by_brand/'.$v_brand->manufacture_id) }}"> <span class="pull-right">(50)</span>{{ $v_brand->manufacture_name }}</a></li>
                                   <?php }?> 
                                </ul>
                            </div>
                        </div><!--/brands_products-->

					...
					<ul class="nav pull-right">
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu">
								...
								<li><a href="#"><i class="halflings-icon user"></i> Profiles</a></li>
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a class="submenu" href="{{URL::to('/manage-order') }}"><i class="icon-file-alt"></i><span class="hidden-tablet"> Manage Orders </span></a></li>
